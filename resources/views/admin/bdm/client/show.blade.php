...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('bdm-clients.index') }}" class="btn btn-secondary mt-2">Back to List</a>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-footer d-flex">
            <a href="{{ route('bdm-clients.edit', $client->id) }}" class="btn btn-warning" style="margin-right: 5px;">Edit</a>
