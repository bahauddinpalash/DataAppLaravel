...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('bdm-leads.index') }}" class="btn btn-secondary mt-2">Back to List</a>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p><strong>Meeting Date:</strong> 
                {{ $lead->client_meeting ? \Carbon\Carbon::parse($lead->client_meeting)->format('Y-m-d H:i') : 'Not Scheduled' }}
            </p>
        ...
        <div class="card-footer d-flex">
            <a href="{{ route('bdm-leads.edit', $lead->id) }}" class="btn btn-warning mr-2">Edit</a>
