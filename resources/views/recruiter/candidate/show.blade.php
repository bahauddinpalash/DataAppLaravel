        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <p>{{ $candidate->total_experience }} years</p>
                </div>
                <div class="col-md-4">
                    <strong>Relevant Experience:</strong>
                    <p>{{ $candidate->relevant_experience }} years</p>
                </div>
                <div class="col-md-4">
                    <strong>Current Salary:</strong>
                    <p>${{ number_format($candidate->current_salary, 2) }}</p>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-4">
                    <strong>Expected Salary:</strong>
                    <p>${{ number_format($candidate->expected_salary, 2) }}</p>
                </div>
                <div class="col-md-4">
