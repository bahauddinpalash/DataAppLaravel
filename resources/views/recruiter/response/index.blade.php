...
<div class="container">
    ...
    <a href="{{ route('candidate_responses.create', $recruit_lead_id) }}" class="btn btn-primary mb-3">Add Response</a>
            ...
            <tbody>
                @foreach ($responses as $response)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('candidate_responses.edit', [$recruit_lead_id, $response->id]) }}" class="btn btn-sm btn-warning">Edit</a>
                            <form action="{{ route('candidate_responses.destroy', [$recruit_lead_id, $response->id]) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
